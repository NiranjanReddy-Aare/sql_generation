...
----------------------------------------------------------------------
0.0         2026-08-18    auto-generated from mapping         ai_agent
**********************************************************************/
...
from po_dedup po
left join cm_mstr on upper(cm_mstr.cm_addr) = upper(po.ad_addr) 
    and upper(cm_mstr.cm_domain) = upper(po.ad_domain)
left join currency on currency.currencycode = cm_mstr.cm_curr
inner join d_cntry_hier on upper(po.ad_ctry) = upper(d_cntry_hier.cntry_alpha2_cd)
;