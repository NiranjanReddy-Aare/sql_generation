/**********************************************************************
artefact name :- generate sql
description   :- generate sql sql generated from mapping
----------------------------------------------------------------------
change log
version :   date :        description :                       changed by
----------------------------------------------------------------------
0.0         2026-09-04    auto-generated from mapping         ai_agent
**********************************************************************/
...
ad_mstr_cte as (
    -- Logic for ad_mstr table here
),
cm_mstr_cte as (
    -- Logic for cm_mstr table here
)
select 
...
from po_dedup po
left join ad_mstr_cte ad
    on ad.ad_addr = cm.cm_addr
left join cm_mstr_cte cm
    on ad.ad_addr = cm.cm_addr
